...
?>
<div class='naslov_smestaj'><h1>Unosi po modelu tip 7</h1></div>
	</div>
	<div class="col-3">
...
$fi=mysqli_query($conn, "SELECT * FROM pages_text WHERE $andidpS id>0 AND tipus=7 $plun ORDER BY pozicija ASC, time DESC");
?>
...
<td>
<?php 
$hg=mysqli_query($conn, "SELECT * FROM slike WHERE idupisa='$og1[id]' AND tip=1");
echo "<a href='$patHA/index.php?base=admin&page=subslike&idupisa=$og1[id]&tip=1&id_page=0'>";
...
?>
<td>
<a href="<?php echo $patHA?>/index.php?base=admin&page=page_edit_content7&id=<?php echo $og1['id']?>" class="edit_oglas"><i class="fas fa-pencil-alt olovcica"></i></a>&nbsp;&nbsp;
