...
?>
<div class='naslov_smestaj'><h1>Unosi po modelu tip 2</h1></div>
	</div>
	<div class="col-3">
...
$fi=mysqli_query($conn, "SELECT * FROM pages_text WHERE $andidpS id>0 AND tipus=2 $plun ORDER BY pozicija ASC, time DESC");
?>
...
?>
<td>
<a href="<?php echo $patHA?>/index.php?base=admin&page=page_edit_content2&id=<?php echo $og1['id']?>" class="edit_oglas"><i class="fas fa-pencil-alt olovcica"></i></a>&nbsp;&nbsp;
