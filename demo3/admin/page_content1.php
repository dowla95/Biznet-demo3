...
$ova1=mysqli_fetch_assoc($ova);
?>
<div class='naslov_smestaj'><h1>Unosi po modelu tip 1</h1></div>
	</div>
	<div class="col-3">
...
<?php 
//$orderby=" id DESC"; if($_GET['id_page']>0 and $_GET['searc']==""){
?>
...
$fi=mysqli_query($conn, "SELECT * FROM pages_text WHERE $andidpS id>0 AND tipus=1 $plun ORDER BY pozicija ASC LIMIT $str,$ByPage1");
?>
...
?>
<td>
<a href="<?php echo $patHA?>/index.php?base=admin&page=page_edit_content1&id=<?php echo $og1['id']?>" class="edit_oglas"><i class="fas fa-pencil-alt olovcica"></i></a>&nbsp;&nbsp;
