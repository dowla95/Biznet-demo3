...
$pter = mysqli_query($conn, "SELECT p.*, pt.*
        ...
        WHERE pt.lang='$lang'  AND p.akt='Y' AND p.id_page=62 ORDER BY time DESC LIMIT 3");
...
?>
						<div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="">
							<div class="blog-item">
								<a href='<?php echo $patH1?>/blog/<?php echo $izg2["ulink"]?>/'>
								...
								<h3><a href='<?php echo $patH1?>/blog/<?php echo $izg2["ulink"]?>/'><?php echo $izg2['naslov']?></a></h3>
